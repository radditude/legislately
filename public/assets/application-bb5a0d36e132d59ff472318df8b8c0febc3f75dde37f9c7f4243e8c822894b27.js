...
// source: app/assets/javascripts/views/about.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/about.html", '<div class="jumbotron">\n  <h1>About</h1>\n  <p class="jumbotron-body">LegisLately is hand-crafted and maintained by the one and only <a class="jumbotron-text-link" href="http://radditude.co" target="_blank">CJ Horton</a> using AngularJS, Ruby on Rails, Bootstrap, and Devise.</p>\n  <p class="jumbotron-body">Data is provided by the <a class="jumbotron-text-link" href="https://www.propublica.org/datastore/api/propublica-congress-api" target="_blank">ProPublica Congress API</a>, with address searching through the <a class="jumbotron-text-link" href="https://developers.google.com/civic-information/" target="_blank">Google Civic Information API</a>.</p>\n  <p class="jumbotron-body">Feedback and contributions are welcomed on <a class="jumbotron-text-link" href="https://github.com/radditude/legislately" target="_blank">Github</a>. Criticisms should be carefully written down, rolled into a ball, and tossed gently into the nearest body of water (or you could <a class="jumbotron-text-link" href="https://github.com/radditude/legislately/issues" target="_blank">open a Github issue</a>. Whatever).</p>\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/coming-soon.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/coming-soon.html", '<div class="jumbotron">\n  <h2>Coming Soon</h2>\n  <h4>To a House of Congress Near You</h4>\n</div>\n\n<table class="table">\n  <tr ng-repeat="bill in soon.bills">\n    <td>{{ bill.legislative_day | date: "MMM d"}}</td>\n    <td><a href="{{bill.url}}" class="capitalize" target="_blank">{{ bill.chamber }}</a></td>\n    <td>{{ bill.description }} {{ bill.context }}</td>\n  </tr>\n</table>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/home.html.erb

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/home.html", '<div class="jumbotron">\n  <h1>Find your Legislators</h1>\n  <h3>Search for an address below</h3>\n  <br>\n  <form ng-submit="home.findLegislators(home.address)">\n    <div class="input-group">\n      <input type="text" class="form-control input-lg" placeholder="999 Anywhere Pl, Anytown, AS 12345" ng-model="home.address">\n      <span class="input-group-btn">\n        <button class="btn btn-default input-lg" type="submit">Go!</button>\n      </span>\n    </div><!-- /input-group -->\n  </form>\n</div>\n\n<div ng-if="home.loading" class="center padding">\n  <img src="/assets/loadingicon-e7b44c86b050fca766a96ddac2d0932af0126da6f2305280342d909168dcce6b.gif" alt="Loadingicon" />\n</div>\n\n<div ng-if="home.error" class="votes-container">\n  <div class="panel panel-danger">\n    <div class="panel-heading">\n      <h4>Sorry</h4>\n    </div>\n    <div class="panel-body">\n      We couldn\'t find anything for that search!\n    </div>\n  </div>\n</div>\n\n<div class="row">\n  <div class="list-group">\n    <div ng-repeat="result in home.results.reps">\n      <a ui-sref="show.activity({ id: result.id })" class="list-group-item">\n        <h3 class="list-group-item-heading">\n          {{ result.name }} | Up for re-election in {{ result.next_election }}\n        </h3>\n        <p class="list-group-item-text">{{ result.role }}, {{ result.party }}</p>\n      </a>\n    </div>\n  </div>\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/login.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/login.html", '<div class="jumbotron">\n  <h1>Log In</h1>\n  <form class="form-horizontal" ng-submit="auth.login()">\n    <div class="form-group">\n      <label class="col-sm-2 control-label">Email</label>\n      <div class="col-sm-10">\n        <input class="form-control" type="email" placeholder="Email" ng-model="auth.user.email" autofocus>\n      </div>\n    </div>\n    <div class="form-group">\n      <label class="col-sm-2 control-label">Password</label>\n      <div class="col-sm-10">\n        <input class="form-control" type="password" placeholder="Password" ng-model="auth.user.password">\n      </div>\n    </div>\n    <div class="form-group">\n      <div class="col-sm-offset-2 col-sm-10">\n        <input class="btn btn-default" type="submit" value="Log In">\n      </div>\n    </div>\n  </form>\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/nav.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/nav.html", '<nav class="navbar navbar-default">\n  <div class="container-fluid">\n    <!-- Brand and toggle get grouped for better mobile display -->\n    <div class="navbar-header">\n      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">\n        <span class="sr-only">Toggle navigation</span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n        <span class="icon-bar"></span>\n      </button>\n      <a class="navbar-brand" id="navbar-brand" ui-sref="home">Legislately</a>\n    </div>\n\n    <!-- Collect the nav links, forms, and other content for toggling -->\n    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\n      <ul class="nav navbar-nav">\n        <li><a ui-sref="newsfeed" ng-show="signedIn()">newsfeed</a></li>\n        <li><a ui-sref="coming-soon">Coming Soon</a></li>\n        <li><a ui-sref="about">About</a></li>\n      </ul>\n      <!-- TODO: remove search box if we decide not to provide full search -->\n      <!-- <form class="navbar-form">\n        <div class="form-group">\n          <input type="text" class="form-control" placeholder="Search legislators by name">\n        </div>\n        <button type="submit" class="btn btn-default">Submit</button>\n      </form> -->\n      <ul class="nav navbar-nav navbar-right">\n        <li ng-hide="signedIn()"><a ui-sref="login">Login</a></li>\n        <li ng-hide="signedIn()"><a ui-sref="register">Register</a></li>\n        <li ng-show="signedIn()"><a ng-click="logout()" ui-sref="home">Log Out</a></li>\n      </ul>\n    </div><!-- /.navbar-collapse -->\n  </div><!-- /.container-fluid -->\n</nav>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/newsfeed.html.erb

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/newsfeed.html", '<input type="text" class="form-control input-lg" placeholder="Search for subjects or specific bills" ng-model="feed.search">\n\n<div ng-if="feed.loading" class="center padding">\n  <img src="/assets/loadingicon-e7b44c86b050fca766a96ddac2d0932af0126da6f2305280342d909168dcce6b.gif" alt="Loadingicon" />\n</div>\n\n<div ng-if="!feed.loading && !feed.actualData" class="votes-container">\n  <div class="panel panel-danger">\n    <div class="panel-heading">\n      <h4>You\'re not following anybody</h4>\n    </div>\n    <div class="panel-body">\n      Go <a ui-sref="home">find your legislators!</a>\n    </div>\n  </div>\n</div>\n\n<div class="votes-container">\n  <div class="panel panel-default" ng-repeat="vote in feed.actualData | orderBy: \'date\' : true | filter: feed.search ">\n    <div class="panel-heading">\n      <h4 class="panel-title">\n        <i>{{ vote.date | date : "M/d" }}</i> |\n        <b><a ui-sref=\'show.info({ id: vote.member_id })\'>{{ feed.following[vote.member_id] }}</a></b>\n        voted <b>{{ vote.position }}</b>\n        <span ng-if="vote.bill.number">on {{ vote.bill.number }}</span>\n      </h4>\n    </div>\n    <div class="panel-body">\n\n      <p><i>{{ vote.question }}</i> <span ng-if="vote.description">- {{ vote.description }}</span></p>\n      <p>{{ vote.bill.title }}</p>\n    </div>\n  </div>\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/register.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/register.html", '<div class="jumbotron">\n  <h1>Register</h1>\n  <form class="form-horizontal" ng-submit="auth.register()">\n    <div class="form-group">\n      <label class="col-sm-2 control-label">Email</label>\n      <div class="col-sm-10">\n        <input class="form-control" type="email" placeholder="Email" ng-model="auth.user.email" autofocus>\n      </div>\n    </div>\n    <div class="form-group">\n      <label class="col-sm-2 control-label">Username</label>\n      <div class="col-sm-10">\n        <input class="form-control" type="username" placeholder="Username" ng-model="auth.user.username">\n      </div>\n    </div>\n    <div class="form-group">\n      <label class="col-sm-2 control-label">Password</label>\n      <div class="col-sm-10">\n        <input class="form-control" type="password" placeholder="Password" ng-model="auth.user.password">\n      </div>\n    </div>\n    <div class="form-group">\n      <div class="col-sm-offset-2 col-sm-10">\n        <input class="btn btn-default" type="submit" value="Sign Up">\n      </div>\n    </div>\n  </form>\n\n  <p>Already signed up? <a ui-sref="login" class="jumbotron-text-link">Log in.</a></p>\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/show.activity.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/show.activity.html", '<ul class="nav nav-tabs">\n  <li role="presentation" class="active">\n    <a ui-sref="show.activity({ id: show.profile.member_id })">\n      Activity\n    </a>\n  </li>\n  <li role="presentation">\n    <a ui-sref="show.info({ id: show.profile.member_id })">\n      Profile\n    </a>\n  </li>\n</ul>\n\n<div class="form-group input-padding">\n  <input type="text" class="form-control input-lg" placeholder="Search for subjects or specific bills" ng-model="show.search">\n</div>\n\n\n<div class="votes-container">\n  <div class="panel panel-default" ng-repeat="vote in show.votes | filter: show.search">\n    <div class="panel-heading">\n      <h4 class="panel-title">\n        <i>{{ vote.date | date : "M/d" }}</i> |\n        <b>{{ show.profile.first_name}} {{ show.profile.last_name }}</b>\n        voted <b>{{ vote.position }}</b> {{ vote.question }}\n      </h4>\n    </div>\n    <div class="panel-body">\n      {{ vote.description }}\n    </div>\n  </div>\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/show.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/show.html", '<div class="jumbotron">\n  <h2>\n    {{ show.profile.first_name }} {{ show.profile.last_name }}&nbsp;&nbsp;\n    <a class="btn btn-default btn-xs follow-btn" ng-click=\'show.follow(show.profile.member_id, "follow")\' ng-if="!show.following">Follow</a>\n    <a class="btn btn-default btn-xs follow-btn active" ng-click=\'show.follow(show.profile.member_id, "unfollow")\' ng-if="show.following">Following</a>\n  </h2>\n\n  <p class="jumbotron-body">{{ show.profile.roles[0].title }} ({{ show.profile.current_party }}-{{ show.profile.roles[0].state }}{{ show.profile.roles[0].district }})</p>\n</div>\n\n<ui-view></ui-view>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/views/show.info.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("views/show.info.html", '<ul class="nav nav-tabs">\n  <li role="presentation">\n    <a ui-sref="show.activity({ id: show.profile.member_id })">\n      Activity\n    </a>\n  </li>\n  <li role="presentation" class="active">\n    <a ui-sref="show.info({ id: show.profile.member_id })">\n      Profile\n    </a>\n  </li>\n</ul>\n\n<div class="show-info-container">\n  <div class="row">\n    <div class="col-sm-6">\n      <div class="panel panel-default">\n        <div class="panel-heading">\n          <h3 class="contrast-text">Next Election</h3>\n        </div>\n        <div class="panel-body">\n          <h1 class="huge-text contrast-text"><b>{{ show.profile.next_election }}</b></h1>\n        </div> <!-- panel-body -->\n      </div> <!-- panel -->\n    </div> <!-- col-sm-6 -->\n    <div class="col-sm-6">\n      <div class="panel panel-default">\n        <div class="panel-heading">\n          <h3 class="contrast-text">Stats</h3>\n        </div>\n        <div class="panel-body">\n          <p>Bills sponsored: {{ show.profile.roles[0].bills_sponsored }}</p>\n          <p>Bills cosponsored: {{ show.profile.roles[0].bills_cosponsored }}</p>\n          <p>Votes with party {{ show.profile.roles[0].votes_with_party_pct }}% of the time</p>\n          <p>Misses votes {{ show.profile.roles[0].missed_votes_pct }}% of the time</p>\n          <p ng-if="show.profile.roles[0].committees">Committees:\n            <ul>\n              <li ng-repeat="committee in show.profile.roles[0].committees">\n                {{ committee.name }}\n              </li>\n            </ul>\n          </p>\n        </div> <!-- panel-body -->\n      </div> <!-- panel -->\n    </div> <!-- col-sm-6 -->\n  </div> <!-- row -->\n\n  <div class="row">\n    <div class="col-sm-6">\n      <div class="panel panel-default">\n        <div class="panel-heading">\n          <h3 class="contrast-text">Contact</h3>\n        </div>\n        <div class="panel-body">\n          <p ng-if="show.profile.roles[0].contact_form"><a href="{{ show.profile.roles[0].contact_form }}" target="_blank">Contact Form</a></p>\n          <p ng-if="show.profile.roles[0].phone">Phone: <a href="tel:{{ show.profile.roles[0].phone}}">{{ show.profile.roles[0].phone}}</a></p>\n          <p ng-if="show.profile.roles[0].fax">Fax: {{ show.profile.roles[0].fax }}</p>\n          <p ng-if="show.profile.roles[0].office">{{ show.profile.roles[0].office }}</p>\n        </div> <!-- panel-body -->\n      </div> <!-- panel -->\n    </div> <!-- col-sm-6 -->\n    <div class="col-sm-6">\n      <div class="panel panel-default">\n        <div class="panel-heading">\n          <h3 class="contrast-text">Links</h3>\n        </div>\n        <div class="panel-body">\n          <span ng-if="show.profile.url"><a href="{{ show.profile.url }}" target="_blank">Home Page</a><br></span>\n          <span ng-if="show.profile.twitter_account" target="_blank">Twitter: <a href="https://www.twitter.com/{{ show.profile.twitter_account }}">{{ show.profile.twitter_account }}</a><br></span>\n          <span ng-if="show.profile.facebook_account" target="_blank">Facebook: <a href="https://www.facebook.com/{{ show.profile.facebook_account }}">{{ show.profile.facebook_account }}</a><br></span>\n          <span ng-if="show.profile.youtube_account" target="_blank">Youtube: <a href="https://www.youtube.com/{{ show.profile.youtube_account }}">{{ show.profile.youtube_account }}</a></span>\n        </div> <!-- panel-body -->\n      </div> <!-- panel -->\n    </div> <!-- col-sm-6 -->\n  </div> <!-- row -->\n</div> <!-- show-info-container -->')
}]);
